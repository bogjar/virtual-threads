...
public class CompletableFuturesTests {
	...
	public static void run() {
		...
		CompletableFuture<List<File>> imageFilesFuture = OptionsImages.instance()
		...
		OptionsImages.instance().printStats("Completable futures test",
	...
	(CompletableFuture<Image> imageFuture) {
		return OptionsImages.instance().transforms()
