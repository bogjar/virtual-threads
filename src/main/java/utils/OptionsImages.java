...
public class OptionsImages {
	 ...
	 * Logging tag.
	 */
	private static final String TAG = OptionsImages.class.getName();

	/**
	 * The singleton {@link OptionsImages} instance.
	 */
	private static OptionsImages mUniqueInstance = null;
	 ...
	 */
	public static OptionsImages instance() {
		if (mUniqueInstance == null)
			mUniqueInstance = new OptionsImages();
